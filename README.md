...
本文提供**两种工作流**，以**方案 A（保留 LaTeX → MathType）**为主线详细展开，方案 B（Word 原生公式）作为备选。
...
> **如果你已经在用 MathType**，方案 A 能让你的 Obsidian → Word 工作流无缝衔接，且 MathType 转出的公式排版优于 Word 原生公式。
>
...
如果你使用 Obsidian 社区的 **Pandoc Plugin**，在插件设置的 `Extra Pandoc arguments` 中填入：
